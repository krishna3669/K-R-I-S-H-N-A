  ...
  switch (type) {
        case "pending": {
          switch (body) {
   			...
   			api.sendMessage(`💐𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐊𝐑𝐈𝐒𝐇𝐍𝐀 𝐁𝐎𝐓 𝐁𝐀𝐁𝐘💐 😇👈=𝐎𝐰𝐧𝐞𝐫 ➻    🌹 𝐌𝐑.𝐊𝐑𝐈𝐒𝐇𝐍𝐀 💝\n✧═════════•❁❀❁•═════════✧\n💐𝐀𝐏𝐊𝐄 𝐆𝐑𝐎𝐔𝐏 𝐊𝐎 𝐌𝐄𝐑𝐄 𝐁𝐎𝐒𝐒 𝐀𝐑𝐘𝐀𝐍 𝐍𝐄 𝐀𝐏𝐏𝐑𝐎𝐕𝐄 𝐊𝐀𝐑 𝐃8𝐘𝐀 𝐇𝐀𝐈𝐈💐 =𝐎𝐰𝐧𝐞𝐫 ➻    🌹 𝐌𝐑.𝐊𝐑𝐈𝐒𝐇𝐍𝐀 🌹\n${idBox}`, threadID, () => {
...
module.exports.run = async ({ event, api, args, Threads, handleReply, Users }) => {
  ...
  const cre = this.config.credits
      ...
      api.sendMessage(`[ OK ] Your group has been removed from the browsing list by the admin for the reason: ${lydo}`, idBox);
   	...
   	else api.sendMessage("💐𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐊𝐑𝐈𝐒𝐇𝐍𝐀 𝐁𝐎𝐓 𝐁𝐀𝐁𝐘💐 😇\n✧═════════•❁❀❁•═════════✧\n💐𝐀𝐏𝐊𝐄 𝐆𝐑𝐎𝐔𝐏 𝐊𝐎 𝐌𝐄𝐑𝐄 𝐁𝐎𝐒𝐒 𝐒𝐇𝐀𝐀𝐍 𝐍𝐄 𝐀𝐏𝐏𝐑𝐎𝐕𝐄 𝐊𝐀𝐑 𝐃𝐈𝐘𝐀 𝐇𝐀𝐈𝐈💐 𝐎𝐰𝐧𝐞𝐫 ➻    🌹 𝐌𝐑.𝐊𝐑𝐈𝐒𝐇𝐍𝐀 🌹\n✧═════════•❁❀❁•═════════✧\n🇪 🇳 🇯 🇴 🇾 \n✧═════════•❁❀❁•═════════✧\n𝐀𝐩𝐏𝐤𝐀 𝐏𝐲𝐑𝐚 𝐎𝐰𝐧𝐞𝐫 ➻    🌹 𝐌𝐑.𝕂ℝ𝕀𝕊ℍℕ𝔸 🌹\n✧═════════•❁❀❁•═════════✧\n𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 𝐥𝐢𝐧𝐤 😊👈 𝐌𝐑.𝐊𝐑𝐈𝐒𝐇𝐍𝐀 :- ☞ \nhttps://www.facebook.com/profile.php?id=100062282613155&mibextid=ZbWKwL\n✧════════•❁❀❁•═════════✧\n💐𝐊𝐈𝐒𝐈 𝐁𝐇𝐈 𝐓𝐀𝐑𝐀𝐇 𝐊𝐈 𝐇𝐄𝐋𝐏 𝐋𝐄𝐍𝐄 𝐊 𝐋𝐈𝐘𝐄 𝐌𝐄𝐑𝐄 𝐁𝐎𝐒𝐒 𝐒𝐄 𝐁𝐀𝐓 𝐊𝐀𝐑𝐎💐 𝐎𝐰𝐧𝐞𝐫 ➻    🌹 𝐌𝐑.𝐊𝐑𝐈𝐒𝐇𝐍𝐀 🌹\n✧═════════•❁❀❁•═════════✧\n 👉 [+𝟗𝟏𝟖𝟎𝟗𝟒𝟖𝟐𝟖𝟐𝟑𝟕 ]", idBox, (error, info) => {
